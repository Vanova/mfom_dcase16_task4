...
- [System results](#system-results)
  ...
  * [:pushpin: The CRNN model with the MFoM embedding](#:pushpin:-the-crnn-model-with-the-mfom-embedding)
  * [:pushpin: Comparison table of results](#:pushpin:-comparison-table-of-results)
- [:pushpin: The MFoM approaches](#:pushpin:-the-mfom-approaches)
